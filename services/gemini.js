...
const FALLBACK_TEMPLATES = [
  ...
  'Kế tiếp là {artist} với bài {title}. Lời nhắn được gửi tặng: {message}. Hãy cùng đắm chìm trong giai điệu!',
  'Đến với bài hát tiếp theo, {title} của {artist}. Cùng với lời nhắn: {message}. Chúc mọi người lắng nghe vui vẻ!',
  'Bây giờ chúng ta sẽ cùng nghe {artist} với bài {title}. Đi kèm với lời nhắn: {message}.',
  '{title} của {artist} đang chờ đón các bạn. Một lời nhắn đặc biệt: {message}. Cùng thưởng thức!',
  'Chúng ta tiếp tục với bài {title} do {artist} trình bày. Lời nhắn: {message}. Mời mọi người lắng nghe!',
  'Tiếp đến là bài {title} của {artist}. Với lời nhắn ý nghĩa: {message}.',
  ...
  'Bài {title} của {artist} sẽ đồng hành cùng các bạn. Lời nhắn: {message}. Cùng lắng nghe nhé!',
  'Tiếp theo, chúng ta có {artist} với bài {title}. Một món quà âm nhạc với lời nhắn: {message}.',
  'Bây giờ chúng ta cùng thưởng thức {title} của {artist}. Đi kèm lời nhắn: {message}. Mời các bạn!'
];
...
- Nhắc đến tên bài hát và tên ca sĩ một cách tự nhiên
...
- "Tiếp theo chúng ta sẽ cùng đi đến bài [tên bài] của [ca sĩ]..."
- "Bây giờ là bài [tên bài] do [ca sĩ] thể hiện..."
- "Kế tiếp, chúng ta cùng lắng nghe [ca sĩ] với bài [tên bài]..."
- "Chúng ta sẽ tiếp tục với bài [tên bài] của [ca sĩ]..."
- "Đến với bài hát tiếp theo, [tên bài] của [ca sĩ]..."`;
